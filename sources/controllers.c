...
pi_struct controller_w = {.K = 0.5, .I = 0.002, .lim_max = 50, .lim_min = -50};
pi_struct controller_id = {.K = 2.5, .I = 0.01, .lim_max = 300, .lim_min = -300, .buffer = 0.0};
pi_struct controller_iq = {.K = 2.5, .I = 0.01, .lim_max = 300, .lim_min = -300, .buffer = 0.0};
